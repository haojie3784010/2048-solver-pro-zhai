	...
	public partial class GameWindow : Form
	{
		...
		private void CreateTiles()
		{
			...
			for (var i = 0; i < 16; i++)
			{
				...
				l.BackColor = ColorTranslator.FromHtml("#c6cdb4");
			...
			boardContainer.BackColor = ColorTranslator.FromHtml("#ebe4e1");
		}
        ...
        private void boardContainer_Paint(object sender, PaintEventArgs e)
        {

        }

        private void numericExpectimaxDepth_ValueChanged(object sender, EventArgs e)
        {
